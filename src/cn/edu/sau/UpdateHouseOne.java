...
/**
 * Servlet implementation class UpdateHouseOne
 */
@WebServlet("/UpdateHouseOne")
public class UpdateHouseOne extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean IsExit = impl.updateHouse(jsonObject);
        //开始返回数据
