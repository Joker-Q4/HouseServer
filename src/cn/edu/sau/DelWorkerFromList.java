...
/**
 * Servlet implementation class DelWorkerFromList
 */
@WebServlet("/DelWorkerFromList")
public class DelWorkerFromList extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean IsExit = impl.delWorkerFromList(username, password);
        //开始返回数据
