...
/**
 * Servlet implementation class AddContractToList
 */
@WebServlet("/AddContractToList")
public class AddContractToList extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean IsExit = impl.addContractToList(jsonObject);
        //开始返回数据
