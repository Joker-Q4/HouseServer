...
/**
 * Servlet implementation class DeleteHouseOne
 */
@WebServlet("/DeleteHouseOne")
public class DeleteHouseOne extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean IsExit = impl.deleteHouse(jsonObject);
        //开始返回数据
