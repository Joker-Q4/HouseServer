...
/**
 * Servlet implementation class AddTDemandToList
 */
@WebServlet("/AddTDemandToList")
public class AddTDemandToList extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean IsExit = impl.addTenantToList(jsonObject);
        //开始返回数据
