...
/**
 * Servlet implementation class AddHouseToList
 */
@WebServlet("/AddHouseToList")
public class AddHouseToList extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean IsExit = impl.addHouseToList(jsonObject);
        //开始返回数据
