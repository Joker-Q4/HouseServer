...
/**
 * Servlet implementation class AddOwnerToList
 */
@WebServlet("/AddOwnerToList")
public class AddOwnerToList extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean IsExit = impl.addOwnerToList(jsonObject);
        //开始返回数据
